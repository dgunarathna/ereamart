...
public class QuotationController {
    ...
    // mapping for return qutation html page
	...
	//request mapping for load qutation all data - /qutation/alldata
    @GetMapping(value = "/qutation/alldata", produces = "application/json")
	...
	// mapping for insert qutation data
	@PostMapping(value = "/qutation/insert")
